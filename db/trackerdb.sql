...
INSERT INTO `student` (`id`, `user_id`, `cohort_id`, `first_name`, `last_name`, `email`, `github_username`, `is_vettec`, `is_gi_bill`, `is_employed`, `is_accepted`, `deposit_paid`, `needs_loaner_laptop`, `education_level`, `open_to_relocation`, `clearance`) VALUES (3, 3, 23, 'New', 'Guy', 'stu3@test.com', NULL, 1, 0, 0, 1, 1, 1, 'Associate', 1, 'None');
